...
allTurns <- read.csv("SolutionFiles/optimalSolutionNew.txt", header = FALSE, sep = "|", col.names = c("gamestate", "value", ".s1","p1_optimal",".s2", "p2_optimal", ".m", "value_matrix")) %>% 
...
# Interpret these as "increase in the odds of winning"
